...
var EFFECT_BASE_DEAD_ROBOT = exports.EFFECT_BASE_DEAD_ROBOT = 4;
var EFFECT_DEAD_RED_ROBOT = EFFECT_BASE_DEAD_ROBOT + 0;
var EFFECT_DEAD_YELLOW_ROBOT = EFFECT_BASE_DEAD_ROBOT + 1;
var EFFECT_DEAD_ORANGE_ROBOT = EFFECT_BASE_DEAD_ROBOT + 2;
var EFFECT_DEAD_TRACTOR1_ROBOT = EFFECT_BASE_DEAD_ROBOT + 3;
var EFFECT_DEAD_TRACTOR2_ROBOT = EFFECT_BASE_DEAD_ROBOT + 4;
...
function Effect(rect, type, end_size, end_time) {
  ...
  this.type = type;
  if (type < EFFECT_BASE_DEAD_ROBOT) {
  ...
  switch (type) {
    ...
    case EFFECT_DEAD_RED_ROBOT:
      this.image = gamejs.image.load(dead_robot_images[EFFECT_DEAD_RED_ROBOT-EFFECT_BASE_DEAD_ROBOT]);
      break;
    case EFFECT_DEAD_YELLOW_ROBOT:
      this.image = gamejs.image.load(dead_robot_images[EFFECT_DEAD_YELLOW_ROBOT-EFFECT_BASE_DEAD_ROBOT]);
      break;
    case EFFECT_DEAD_ORANGE_ROBOT:
      this.image = gamejs.image.load(dead_robot_images[EFFECT_DEAD_ORANGE_ROBOT-EFFECT_BASE_DEAD_ROBOT]);
      break;
    case EFFECT_DEAD_TRACTOR1_ROBOT:
      this.image = gamejs.image.load(dead_robot_images[EFFECT_DEAD_TRACTOR1_ROBOT-EFFECT_BASE_DEAD_ROBOT]);
      break;
    case EFFECT_DEAD_TRACTOR2_ROBOT:
      this.image = gamejs.image.load(dead_robot_images[EFFECT_DEAD_TRACTOR2_ROBOT-EFFECT_BASE_DEAD_ROBOT]);
      break;
    default:
...
Effect.prototype.update = function(ms) {
  ...
  if (this.type < EFFECT_BASE_DEAD_ROBOT) {
